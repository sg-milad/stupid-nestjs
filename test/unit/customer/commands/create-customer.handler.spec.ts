...
// Mock modules
jest.mock(
  '../../../../src/domain/customer/value-objects/phone-number.value-object',
);
jest.mock('../../../../src/domain/customer/value-objects/email.value-object');
jest.mock(
  '../../../../src/domain/customer/value-objects/bank-account.value-object',
);
...
describe('CreateCustomerHandler', () => {
  ...
  describe('execute', () => {
    it('should create a customer when it does not exist', async () => {
      ...
      expect(customerRepository.existsByEmail).toHaveBeenCalledWith(
        command.email,
      );
