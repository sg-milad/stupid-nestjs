import { Body, Controller, Get, Param, Post, BadRequestException, UsePipes, ValidationPipe } from "@nestjs/common";
...
export class CustomerController {
    ...
    async getCustomer(@Param("id") id: string): Promise<CustomerResponseDto> {
        const customerDto: CustomerDto = await this.queryBus.execute(new GetCustomerQuery(id));
